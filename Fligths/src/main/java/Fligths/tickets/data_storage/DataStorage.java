package Fligths.tickets.data_storage;
...
public class DataStorage {
    ...
    public DataStorage(
        ...
        String departure_time, String arrival_date, String arrival_time, String carrier, int stops, int price, String durationTime
    ) {
        this.origin = origin;
